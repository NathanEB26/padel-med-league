...
## 3. Stories à la une (Highlights)
Créez ces 4 bulles permanentes :
- **▶️ C'est quoi ?** (le concept en 3 stories)
- **📝 S'inscrire** (comment rejoindre)
- **🏆 Classement** (mis à jour chaque journée)
- **📸 Les matchs** (photos des équipes)

---

## 4. Les 3 piliers de contenu

| Pilier | Quoi | Fréquence |
|---|---|---|
| **🗓️ Événements** | Affiches des matchs de la journée (avant), rappels, finale | À chaque journée |
| **🏆 Résultats** | Scores, podium du classement, exploits de la semaine | À chaque journée |
| **👥 Communauté** | Portraits d'équipes, recherche de partenaires, coulisses | 1-2 / semaine |
...
> 🟢 Les Coronaires (Centre) 🆚 Smash Réa (Nord-Est) 🔴
> Niveau ≈ 6 · à vos bandejas ! Résultat à suivre 👀

### c) Résultat (pilier Résultats)
> 🏆 **RÉSULTAT — J3**
> Smash Réa 🆚 Les Coronaires : **2-1** 🔥
> Les réanimateurs s'imposent au super tie-break. Belle remontada des cardios !
> Classement complet 👉 lien en bio

### d) Podium de la semaine
> 📊 **LE PODIUM — Semaine 3**
> 🥇 Smash Réa · 🥈 Les Néphrons · 🥉 Les Scanners
...
## 6. Hashtags (mix portée + ciblage local)
```
...
## 7. Rythme conseillé
- **Phase lancement** : 3-4 posts / semaine + stories régulières.
- **En régime** : 1 post « affiche » + 1 post « résultat » par journée, + 1
  contenu communauté. Les **stories** font le quotidien (peu d'effort, fort impact).

---

## 8. Générer les visuels « résultats » automatiquement
Les affiches et résultats peuvent être **produits par le site** plutôt qu'à la
main : une page qui transforme un match (équipes, zones, niveaux, score) en une
**image carrée prête pour Instagram**, aux couleurs de la ligue.
➡️ **Je peux ajouter cette fonction à l'appli** (un bouton « Visuel Insta » sur
chaque match) — dites-moi si on le fait, c'est le prolongement naturel de votre
demande sur les résultats.

---

## 9. Ce dont j'ai besoin de vous
1. Le **@ du compte** une fois créé → je l'intègre au site.
2. Un **feu vert** si vous voulez le générateur de visuels dans l'appli.
3. (Optionnel) Que je vous **génère le logo** (balle verte) en image pour la photo
   de profil.
